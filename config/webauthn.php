...
return [
    ...
    */
    ...
    'redirects' => [
        'login' => '/admin',
        'register' => '/admin/perfil',
        'key-confirmation' => '/admin',
    ],
    ...
    */
    ...
    'user_verification' => 'preferred', // 'preferred' permite usernameless, 'required' força verificação
    ...
    */
    ...
    'resident_key' => 'required', // 'required' necessário para usernameless (discoverable credentials)
    ...
    |
    | IMPORTANTE: Quando userless está ativo, o resident_key deve ser 'required'
    | e user_verification deve ser 'required' ou 'preferred'.
    |
    */

    'userless' => (bool) env('WEBAUTHN_USERLESS', true), // Ativado por padrão para suportar autenticação sem email
